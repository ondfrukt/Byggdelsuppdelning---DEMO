                    ...
                    ${!isEditLikeMode ? `
                        <div class="form-group form-group-compact">
                            ...
                            <input type="text" 
                                   ...
                                   class="form-control readonly-autogenerated"
                                   readonly>
                            <small class="form-help">Version hanteras automatiskt</small>
                        </div>
                        <div class="form-group form-group-compact">
                            <label for="field-main_id">BaseID</label>
                            <input type="text" 
                                   id="field-main_id" 
                                   name="main_id"
                                   ...
                                   class="form-control readonly-autogenerated"
                                   readonly>
                            <small class="form-help">BaseID genereras automatiskt vid skapande</small>
                        </div>
                    ` : ''}
                </div>
            </div>
