"""Normalize structural object relations to match configured object-pair rules."""
...
def get_expected_structural_rule(source_object, target_object):
...
def normalize_structural_relations():
    updated = []
    deleted_duplicates = []
    ...
    with app.app_context():
        ...
        for relation in relations:
            ...
            expected_type = get_expected_structural_rule(source_object, target_object)
...
if __name__ == '__main__':
    result = normalize_structural_relations()
